        ...
        <div class="container">
            ...
            <div class="row">
                <ul class="nav nav-tabs">
                    ...
                    <li role="presentation" class="active"><a href="#">Equipamento</a></li>
            ...
            <div class="tab-pane row">
                ...
                <div class="col-sm-10 col-md-10"  ng-app="equipmentRegister" ng-controller="equipmentRegisterCtrl">


                    <!-- panel de listagem de áreas -->
                    <div class="col-sm-5 col-md-5" ng-hide="">
                                    ...
                                    <div class="col-sm-12 col-md-12 ">
                                        ...
                                        <div class="list-group">
                                            ...
                                            <a href="#" 
                                               ...
                                               ng-click="selectedArea.set(area)">
                    ...
                    <!-- panel de listagem de equipamentos -->
                    <div class="col-sm-5 col-md-5" ng-hide="formEquipment.formEditEquipment.active()">
                        <div class="panel panel-default panel-info">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12 ">
                                        ...
                                        <div class="list-group">
                                            ...
                                            <a href="#" 
                                               class="list-group-item" 
                                               ng-repeat="equipment in formEquipment.equipments" 
                                               ng-class="{active: equipment == formEquipment.selectedEquipment.equipment}" 
                                               ng-click="formEquipment.selectedEquipment.set(equipment)">
